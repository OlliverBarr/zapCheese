...
export declare namespace LibBarnStorage {
...
export interface VCheezInterface extends utils.Interface {
  functions: {
    ...
    'initBarn(address,address)': FunctionFragment;
  ...
  encodeFunctionData(functionFragment: 'bondStaked', values?: undefined): string;
  encodeFunctionData(functionFragment: 'bondStakedAtTs', values: [BigNumberish]): string;
  ...
  encodeFunctionData(functionFragment: 'initBarn', values: [string, string]): string;
  ...
  decodeFunctionResult(functionFragment: 'bondStakedAtTs', data: BytesLike): Result;
...
export interface VCheez extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VCheezInterface;
  ...
  functions: {
    ...
    bondStakedAtTs(timestamp: BigNumberish, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    ): Promise<[LibBarnStorage.StakeStructOutput]>;
  ...
  callStatic: {
    ...
    initBarn(_bond: string, _rewards: string, overrides?: CallOverrides): Promise<void>;
  ...
  populateTransaction: {
    ...
    bondStakedAtTs(timestamp: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>;
