...
const groupId = CHEESE_GAME_ZAPPER_DEFINITION.groups.wsCheez.id;
const network = Network.HARMONY_MAINNET;

@Register.TokenPositionFetcher({ appId, groupId, network })
export class HarmonyCheeseGameZapperWsCheezTokenFetcher implements PositionFetcher<AppTokenPosition> {
  constructor(
