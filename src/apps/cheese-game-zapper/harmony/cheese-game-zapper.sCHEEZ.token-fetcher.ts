...
const groupId = CHEESE_GAME_ZAPPER_DEFINITION.groups.sCheez.id;
const network = Network.HARMONY_MAINNET;

@Register.TokenPositionFetcher({ appId, groupId, network })
export class HarmonyCheeseGameZapperSCheezTokenFetcher implements PositionFetcher<AppTokenPosition> {
  constructor(
